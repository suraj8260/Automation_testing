...
public class FacebookLoginTest {
    public static void main(String[] args) {
        ...
        try {
            ...
            WebElement emailField = driver.findElement(By.xpath("//input[@id='_R_oiqjbjb9pb6amH1_']"));
            WebElement passwordField = driver.findElement(By.xpath("//input[@id='_R_oqqjbjb9pb6amH1_']"));
